            ...
            <div class="card-header py-3 d-flex">
                ...
                <div class="ml-auto">
                    <a href="{{ route('admin.galleries.create') }}" class="btn btn-success">
                        ...
                        <span class="text">{{ __('New Gallery') }}</span>
                    </a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="data-table" class="table table-bordered table-striped table-hover datatable datatable-role" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr data-entry-id="{{ $gallery->id }}">
                                ...
                                <td>{{ $gallery->title }}</td>
                                <td>{{ $catalogs->where('id', $gallery->catalog_id)->first()->title }}</td>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('admin.galleries.edit', $gallery->id) }}" class="btn btn-info">
                                            <i class="fa fa-pencil-alt"></i>
                                        </a>
                                        <form onclick="return confirm('are you sure ? ')" class="d-inline" action="{{ route('admin.galleries.destroy', $gallery->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
